      ...
      <div className="w-full max-w-[400px] bg-[#09090b] border border-zinc-800/80 rounded-2xl p-8 shadow-2xl relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">
            {mode === 'login' ? 'Sign in to your StoreTap account' : 'Register your business with StoreTap'}
          </p>
        </div>
        ...
        {successMsg && (
          <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-medium p-3 rounded-lg mb-6 text-center">
            {successMsg}
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg mt-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >

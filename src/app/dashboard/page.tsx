...
import { getPendingRequests, getApprovedLicenseRequests, getApprovedSystemRequests, getUsersList, getNotifications, markNotificationsRead, getPendingRequestsCount, approveSystemRequest, getAdminGeneratedLicenses } from '@/app/actions/admin'
                    ...
                    <table className="w-full text-left text-sm min-w-[600px]">
                      ...
                      <tbody className="divide-y divide-zinc-800/60">
                        {loadingApproved ? (
                          ...
                          <tr><td colSpan={4} className="px-6 py-12 text-center text-zinc-500 font-medium">No generated licenses found.</td></tr>
